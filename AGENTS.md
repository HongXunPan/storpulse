...
1. macOS Intel 开发者预览已完成阶段 1–3 源码；Windows x64 开发者预览的 Windows 10 持续协议、异常清理、传统待机恢复、服务后备记录和阶段 2A–2B WinUI 界面与生命周期实机门禁已通过，阶段 2C 真实采集界面、桌面诊断、长期运行和 Windows 11 仍待独立验证。Apple Silicon、旧版 macOS、签名与正式分发保持未验证。
