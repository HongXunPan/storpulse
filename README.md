...
- 当前阶段：macOS Intel 开发者预览阶段 1。
- 当前能力：可复现的 macOS 无界面采集探针、Rust 差值与聚合内核、观察会话和版本化 JSON C ABI。
...
开发环境、验证命令和停机条件见[工程代码技术选型](docs/工程代码技术选型.md)、[共享内核契约](docs/共享内核契约.md)与[贡献指南](CONTRIBUTING.md)。
