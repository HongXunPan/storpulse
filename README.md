...
开发环境、验证命令和停机条件见[工程代码技术选型](docs/工程代码技术选型.md)、[共享内核契约](docs/共享内核契约.md)、[macOS 实时纵切](docs/macOS实时纵切.md)、[低写入历史与导出](docs/低写入历史与导出.md)与[贡献指南](CONTRIBUTING.md)。
